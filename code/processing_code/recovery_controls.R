...
#Sampling Data 
sample_data = data.frame("collection_num" = 5:54, "date" = c("2020-06-16", "2020-06-23", "2020-06-30", "2020-07-07", "2020-07-14", "2020-07-21", "2020-07-28", 
                                                             ...
                                                             "2021-02-15", "2021-02-17"), stringsAsFactors = FALSE)
...
recovery_calc = recovery_calc %>% filter(percent_recovery < 100)
